...
# Natural Speech Delivery (Milestone 29)
# Local delivery-copy normalization/chunking and advisory pacing only.
# Never owns realtime response creation and never authorizes privileged actions.
SPEECH_DELIVERY_ENABLED = True
SPEECH_CHUNK_CHARS_BRIEF = 320
SPEECH_CHUNK_CHARS_NORMAL = 220
SPEECH_CHUNK_CHARS_DETAILED = 140
MAX_SPEECH_CHUNKS = 24
MAX_SPOKEN_LIST_ITEMS = 6
MAX_SPEECH_DELIVERY_STATE_CHARS = 2_000
MAX_RECENT_SPOKEN_FINGERPRINTS = 8
MAX_SPEECH_OPENING_CHARS = 80
MAX_SPEECH_FINGERPRINT_CHARS = 120
MAX_URL_SPEAK_CHARS = 48
MAX_CODE_SPEAK_CHARS = 40
MAX_PARENTHETICAL_SPEAK_CHARS = 48
MAX_SPEECH_DELIVERY_INSTRUCTION_CHARS = 1_200
